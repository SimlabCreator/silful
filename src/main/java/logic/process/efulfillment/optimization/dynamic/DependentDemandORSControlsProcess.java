...
public class DependentDemandORSControlsProcess extends SubProcess {
	...
	public SettingRequest getSettingRequest() {
		...
		algoServices.put(3, this.dynamicProgrammingControlService);
	...
	public void start() {
		...
		try {
			this.initConstructionService.runInsertionConstructionHeuristicFromDemandForecastRatioRequestsVisibilityAsHardConstraint(0);
