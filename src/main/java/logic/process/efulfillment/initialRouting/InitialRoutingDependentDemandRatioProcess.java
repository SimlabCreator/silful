...
public class InitialRoutingDependentDemandRatioProcess extends SubProcess{
	...
	public void start() {
		...
		//Define routing
		try {
			this.initConstructionService.runInsertionConstructionHeuristicFromDemandForecastRatioRequests(0);
