...
public class InitialRoutingDependentDemandProcess extends SubProcess{
	...
	public void start() {
		...
		//Define routing
		try {
			this.initConstructionService.runInsertionConstructionHeuristicFromDemandForecastDuplicateRequests(0);
