...
public class LinearValueFunctionOrienteeringAcceptanceProcess extends SubProcess {
	...
	public SettingRequest getSettingRequest() {
		...
		this.aDPOrienteeringService = new ADPOrienteeringAcceptanceService("ADPWithOrienteeringAcceptance");
	...
	public void start() {
		...
		// Calculate forecast
		try {
			this.aDPOrienteeringService.startLinearFunctionApproximationAcceptance(0);
