...
public class LinearValueFunctionAsYangTrainingProcess extends SubProcess {
	...
	public SettingRequest getSettingRequest() {
		...
		this.aDPService = new ADPService("ADPAsYang");
	...
	public void start() {
		...
		// Calculate forecast
		try {
			this.aDPService.startLinearFunctionApproximationAsYang(0);
