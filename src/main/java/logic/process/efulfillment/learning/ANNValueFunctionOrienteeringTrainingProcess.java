...
public class ANNValueFunctionOrienteeringTrainingProcess extends SubProcess {
	...
	public SettingRequest getSettingRequest() {
		...
		this.aDPOrienteeringService = new ADPOrienteeringService("ADPWithOrienteeringANN");
	...
	public void start() {
		...
		// Calculate forecast
		try {
			this.aDPOrienteeringService.startANNFunctionApproximation(0);
