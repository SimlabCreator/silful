...
public class LinearValueFunctionOrienteeringTrainingProcess extends SubProcess {
	...
	public SettingRequest getSettingRequest() {
		...
		this.aDPOrienteeringService = new ADPOrienteeringService("ADPWithOrienteering");
	...
	public void start() {
		...
		// Calculate forecast
		try {
			this.aDPOrienteeringService.startLinearFunctionApproximation(0);
