...
public class GRILSForLearningAdaptedWithMultipleAreasProcess extends SubProcess {
	...
	public SettingRequest getSettingRequest() {
		...
		this.orienteeringService = new OrienteeringOnRequestsWithMultipleAreasService("GRILSOrienteeringAdaptedWithVehicleAreaAssignment");
