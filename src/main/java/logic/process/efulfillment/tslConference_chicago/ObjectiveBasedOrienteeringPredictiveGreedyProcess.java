package logic.process.efulfillment.tslConference_chicago;
...
public class ObjectiveBasedOrienteeringPredictiveGreedyProcess extends SubProcess {
	...
	public void start() {
		...
		try {
			this.initConstructionService.runOrienteeringPredictiveGreedy(0);
