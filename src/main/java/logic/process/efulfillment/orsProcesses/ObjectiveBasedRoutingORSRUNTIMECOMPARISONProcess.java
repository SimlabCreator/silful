...
public class ObjectiveBasedRoutingORSRUNTIMECOMPARISONProcess extends SubProcess {
	...
	public void start() {
		...
		try {
			this.initConstructionService.runInsertionConstructionHeuristicFromDemandForecastRatioRequestsVisibilityAsHardConstraintRuntimeComparison(0);
