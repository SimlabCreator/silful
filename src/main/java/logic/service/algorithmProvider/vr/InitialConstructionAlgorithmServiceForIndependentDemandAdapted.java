 ...
 *
 */
public class InitialConstructionAlgorithmServiceForIndependentDemandAdapted implements AlgorithmProviderService {

	private String algorithm;

	public InitialConstructionAlgorithmServiceForIndependentDemandAdapted(String algorithm) {
	...
	public Routing runInsertionConstructionHeuristicFromDemandForecast(int periodNumber) {
		...
		for(ForecastedOrderRequest request: requests){
			...
			System.out.println(request.getEstimatedValue());
		}
		...
		Old_InsertionConstructionHeuristicAdaption algo = new Old_InsertionConstructionHeuristicAdaption(requests,
				...
				vehicles, distances, nodes, travelTimeSet, deliveryAreaSet, false);
		algo.start();
