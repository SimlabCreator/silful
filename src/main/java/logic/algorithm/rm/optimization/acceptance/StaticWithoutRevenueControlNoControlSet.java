...
public class StaticWithoutRevenueControlNoControlSet implements AcceptanceAlgorithm{
	...
	public StaticWithoutRevenueControlNoControlSet(CapacitySet capacitySet,
