...
public class ArtificialNeuralNetworkCopy {
	...
	private boolean considerTAndWeights;
	
	
	public ArtificialNeuralNetworkCopy(String[] inputTypes, Integer numberOfHidden, Integer[] inputSetIds,
			Integer[] inputElementIds, double weights[], double thresholds[], 
			double maximumValue, double minimumValue, double theftWeight, 
			boolean thefting, double[] maxValuePerElement, boolean considerConstant, boolean considerDemandNeighbors, boolean considerTAndWeights) {
		...
		this.setConsiderTAndWeights(considerTAndWeights);
	}
	
	public ArtificialNeuralNetworkCopy(){
	...
	public boolean isConsiderTAndWeights() {
		return considerTAndWeights;
	}

	public void setConsiderTAndWeights(boolean considerTAndWeights) {
		this.considerTAndWeights = considerTAndWeights;
	}
