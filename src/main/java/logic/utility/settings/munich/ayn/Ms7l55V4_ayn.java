...
public class Ms7l55V4_ayn {

	String db = "SimLabAYN";
	String basicName = "Ms7l55V4_ayn";
	...
	int arrivalProcess = 18;
	int arrivalProbabilityDistributionId=56;
...
//	int firstOrderRequestSetIdForTOP=21304;
	...
	public Ms7l55V4_ayn() {
		...
		learningRoutingExperimentIds.add(1731);
		learningRoutingExperimentIdsExpected.add(1731);
