package logic.utility.settings.munich.ayn;
...
public class Ms7l315V3_ayn {

	String db = "SimLabAYN";
	String basicName = "Ms7l315V3_ayn";
	int bookingPeriodLength = 500;
	int regionId = 6;
	int depotId = 11;
	int deliveryAreaSetId = 25;
	int vehicleAssignmentSetId = 43;
	int noVehicles =3;
	int demandSegmentWeightingId = 33;
	int serviceSegmentWeightingId=1;
	int timeWindowSetId = 10;
	int arrivalProcess = 17;
	int arrivalProbabilityDistributionId=55;
...
//	int firstOrderRequestSetIdForTOP=21304;
	...
	int learningRequestSetsExperimentId =1524;
	...
	public Ms7l315V3_ayn() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(1531);
		learningRoutingExperimentIdsExpected.add(1531);
...
//				arrivalProcess, false);
	...
	public String runANNAcceptances (int valueFunctionModelSetId) {
		String adpName = "ADP_";
		String resultLog="";
		...
		resultLog= RunExperimentHelper.runANNExperiments(helper, paras, basicName, adpName, regionId, bookingPeriodLength, 
				...
				learningRoutingExperimentIdsExpected, arrivalProcess, 
				firstOrderRequestSetIdForValiation, noVehicles, depotId, resultLog, 	
