...
public class Ms7l385V3_ayn {

	String db = "SimLabAYN";
	String basicName = "Ms7l385V3_ayn";
	...
	int arrivalProcess = 16;
	int arrivalProbabilityDistributionId=54;
...
//	int firstOrderRequestSetIdForTOP=21304;
	...
	int learningRequestSetsExperimentId =1527;
	...
	public Ms7l385V3_ayn() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(1631);
		learningRoutingExperimentIdsExpected.add(1631);
