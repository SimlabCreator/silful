package logic.utility.settings.munich.ys;
...
public class M27l8_ys {

	String db = "SimLabYS";
	String basicName = "M27l8_ys";
...
//	int firstOrderRequestSetIdForTOP=21304;
	...
	public M27l8_ys() {
		...
		learningRoutingExperimentIds.add(5);
		learningRoutingExperimentIdsExpected.add(5);
...
//				arrivalProcess, false);
	...
	public String runANNAcceptances (int valueFunctionModelSetId) {
		...
		resultLog= RunExperimentHelper.runANNExperiments(helper, paras, basicName, adpName, regionId, bookingPeriodLength, 
				...
				firstOrderRequestSetIdForValiation, noVehicles, depotId, resultLog, valueFunctionModelSetId, 3.0);
