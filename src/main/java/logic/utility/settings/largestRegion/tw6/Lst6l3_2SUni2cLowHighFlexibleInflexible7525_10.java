...
public class Lst6l3_2SUni2cLowHighFlexibleInflexible7525_10 {
	
	String basicName = "Lst6l3_2SUni2cLowHighFlexibleInflexible7525_10_";
	...
	public Lst6l3_2SUni2cLowHighFlexibleInflexible7525_10() {
		logic.utility.SettingsProvider.database=db;
		learningRoutingExperimentIds.add(8); // Already checked
		learningRoutingExperimentIdsExpected.add(8);
