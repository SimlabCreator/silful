...
public class Lst6l27_2SUni2cLowHighFlexibleInflexible7525_10 {
	
	String basicName = "Lst6l27_2SUni2cLowHighFlexibleInflexible7525_10_";
	...
	int noVehicles =10;
	int demandSegmentWeightingId = 66;
	...
	public Lst6l27_2SUni2cLowHighFlexibleInflexible7525_10() {
		logic.utility.SettingsProvider.database=db;
		learningRoutingExperimentIds.add(108); // Already checked
		learningRoutingExperimentIdsExpected.add(108);
