...
public class L11ovl405_2S2c4cLowHighFlexibleInflexible7525 {
	
	String db = "SimLabOVL";
	String basicName = "L11ovl405_2S2c4cLowHighFlexibleInflexible7525_";
...
//	int vehicleAssignmentSetId = 41;
	int noVehicles =3;
	int demandSegmentWeightingId = 56;
...
//	int firstOrderRequestSetIdForTOP=37202;
	...
	public L11ovl405_2S2c4cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(129);
		learningRoutingExperimentIdsExpected.add(129);
