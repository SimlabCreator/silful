...
public class L11ovl45_2S2c2cLowLowFlexibleInflexible7525 {
	
	String db = "SimLabOV";
	String basicName = "L11ovl45_2S2c2cLowLowFlexibleInflexible7525_";
...
//	int firstOrderRequestSetIdForTOP=42502;
	...
	public L11ovl45_2S2c2cLowLowFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(32);
		learningRoutingExperimentIdsExpected.add(32);
