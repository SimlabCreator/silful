...
public class L11ovl45_2SU2cLowHighFlexibleInflexible7525 {

	String db = "SimLabOV";
	String basicName = "L11ovl45_2SU2cLowHighFlexibleInflexible7525_";
...
//	int vehicleAssignmentSetId = 41;
	int noVehicles =3;
	int demandSegmentWeightingId = 64;
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 59607;
//	int firstOrderRequestSetIdForTOP=31902;
	int firstOrderRequestSetIdForTOPExpected =59707;
	int learningRequestSetsExperimentId = 12732;
	...
	public L11ovl45_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(12933);
		learningRoutingExperimentIdsExpected.add(12933);
