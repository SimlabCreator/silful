...
public class L11ovl405_2SU2cLowHighFlexibleInflexible7525 {

	String db = "SimLabOVL";
	String basicName = "L11ovl405_2SU2cLowHighFlexibleInflexible7525_";
...
//	int firstOrderRequestSetIdForTOP=31902;
	...
	int learningRequestSetsExperimentId = 12727;
	...
	public L11ovl405_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(12928);
		learningRoutingExperimentIdsExpected.add(12928);
