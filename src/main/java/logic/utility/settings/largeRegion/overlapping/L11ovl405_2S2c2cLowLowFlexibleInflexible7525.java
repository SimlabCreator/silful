...
public class L11ovl405_2S2c2cLowLowFlexibleInflexible7525 {
	
	String db = "SimLabOVL";
	String basicName = "L11ovl405_2S2c2cLowLowFlexibleInflexible7525_";
...
//	int vehicleAssignmentSetId = 41;
	int noVehicles =3;
	int demandSegmentWeightingId = 58;
...
//	int firstOrderRequestSetIdForTOP=42502;
	...
	public L11ovl405_2S2c2cLowLowFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(29);
		learningRoutingExperimentIdsExpected.add(29);
