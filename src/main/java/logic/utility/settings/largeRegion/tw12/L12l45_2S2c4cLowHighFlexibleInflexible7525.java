...
public class L12l45_2S2c4cLowHighFlexibleInflexible7525 {
	
	String basicName = "L12l45_2S2c4cLowHighFlexibleInflexible7525_";
...
//	int vehicleAssignmentSetId = 41;
	int noVehicles =3;
	int demandSegmentWeightingId = 48;
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 5302;
	int firstOrderRequestSetIdForTOP=5402;
	int firstOrderRequestSetIdForTOPExpected =5502;
	int learningRequestSetsExperimentId =9;
	...
	public L12l45_2S2c4cLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(226);
		learningRoutingExperimentIdsExpected.add(326);
