...
public class L12l45_2SUniLowHighFlexibleInflexible7525 {

	String basicName = "L12l45_2SUniLowHighFlexibleInflexible7525_";
...
//	int vehicleAssignmentSetId = 41;
	int noVehicles =3;
	int demandSegmentWeightingId = 47;
	...
	int firstOrderRequestSetIdForTOPExpected =202;
	...
	public L12l45_2SUniLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(26);
		learningRoutingExperimentIdsExpected.add(126);
