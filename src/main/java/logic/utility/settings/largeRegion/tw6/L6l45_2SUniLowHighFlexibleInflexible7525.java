...
public class L6l45_2SUniLowHighFlexibleInflexible7525 {

	String basicName = "L6l45_2SUniLowHighFlexibleInflexible7525_";
...
//	int vehicleAssignmentSetId = 41;
	int noVehicles =3;
	int demandSegmentWeightingId = 50;
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 15902;
	int firstOrderRequestSetIdForTOP=16002;
	int firstOrderRequestSetIdForTOPExpected =16102;
	int learningRequestSetsExperimentId = 17;
	...
	public L6l45_2SUniLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(626);
		learningRoutingExperimentIdsExpected.add(726);
