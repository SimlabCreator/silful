package logic.utility.settings.largeRegion.tw6.veh6;
...
public class L6l27_2SUni2cLowHighFlexibleInflexible7525_6 {
	
	String basicName = "L6l27_2SUni2cLowHighFlexibleInflexible7525_6_";
	int bookingPeriodLength = 1500;
	String db= "SimLab_revision_c";
	int regionId = 9;
	int depotId = 10;
	...
	int learningRequestSetsExperimentId =313;
	...
	public L6l27_2SUni2cLowHighFlexibleInflexible7525_6() {
		logic.utility.SettingsProvider.database=db;
		learningRoutingExperimentIds.add(314);
		learningRoutingExperimentIdsExpected.add(314);
