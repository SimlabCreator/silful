...
public class YANG_T500l8_Experiments {
	
	String basicName = "YST500l0.8_";
	int bookingPeriodLength = 500;
	int regionId = 6;
	int deliveryAreaSetId = 25;
	int vehicleAssignmentSetId = 23;
	int demandSegmentWeightingId = 31;
	int serviceSegmentWeightingId=1;
	int timeWindowSetId = 9;
	int arrivalProcess = 5;
	int arrivalProbabilityDistributionId=31;
	
	//Adapt!
	int firstOrderRequestSetIdForValiation = 10202;
	int firstOrderRequestSetIdForTOP=10302;
	int learningRequestSetsExperimentId = 1921;

	ArrayList<Integer> learningRoutingExperimentIds = new ArrayList<Integer>();
	
	
	public YANG_T500l8_Experiments() {
		learningRoutingExperimentIds.add(10414);
		
		learningRoutingExperimentIds.add(1924);
		learningRoutingExperimentIds.add(9506);
	}
...
//		where run_experiment =13842;
	...
	public void runBenchmarking (boolean fcfs, boolean ann){
		String[]  names= new String[] {
				...
				//"#EcTc", 
				"#EcaTc",
				//"#Tc_d0", "#Tc_d0Type2", "#Tc_d0Type2PerTw",
				//"#IcTc_d0Type2", 
//				"#IcTc_d0Type2PerTw", "#EcaTc_d0Type2", "#EcaTc_d0Type2PerTw",
...
//				"#IcTc_d3Type3_s", "#IcTc_d3Type3PerTw_s", 
				...
				//"#IcTc_d3Type3_s1/3", "#IcTc_d3Type3PerTw_s1/3", 
