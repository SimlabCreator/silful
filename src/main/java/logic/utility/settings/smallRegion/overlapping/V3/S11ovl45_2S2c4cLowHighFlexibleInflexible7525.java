...
public class S11ovl45_2S2c4cLowHighFlexibleInflexible7525 {

	String db = "SimLabOV";
	String basicName = "S11ovl45_2S2c4cLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation =38807;
	//int firstOrderRequestSetIdForTOP=103;
	int firstOrderRequestSetIdForTOPExpected =38907;
	...
	public S11ovl45_2S2c4cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(8594);
		learningRoutingExperimentIdsExpected.add(8594);
