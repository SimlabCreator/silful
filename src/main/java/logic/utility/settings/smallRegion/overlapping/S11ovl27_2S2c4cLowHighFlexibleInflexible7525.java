...
public class S11ovl27_2S2c4cLowHighFlexibleInflexible7525 {

	String db = "SimLabOVL";
	String basicName = "S11ovl27_2S2c4cLowHighFlexibleInflexible7525_";
	...
	int noVehicles =2;
	int demandSegmentWeightingId = 55;
	...
	public S11ovl27_2S2c4cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(4359);
		learningRoutingExperimentIdsExpected.add(4359);
