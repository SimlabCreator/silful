...
public class S11ovl45_2SU2cLowHighFlexibleInflexible7525 {
	
	String db = "SimLabOV";
	String basicName = "S11ovl45_2SU2cLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 54407;
	//int firstOrderRequestSetIdForTOP=5303;
	int firstOrderRequestSetIdForTOPExpected =54507;
	int learningRequestSetsExperimentId = 12729;
	...
	public S11ovl45_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(12833);
		learningRoutingExperimentIdsExpected.add(12833);
