...
public class S11ovl3_2S2c2cLowLowFlexibleInflexible7525 {

	String db = "SimLabOV";
	String basicName = "S11ovl3_2S2c2cLowLowFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 18007;
//	int firstOrderRequestSetIdForTOP=21304;
	int firstOrderRequestSetIdForTOPExpected =18107;
	...
	public S11ovl3_2S2c2cLowLowFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(4264);
		learningRoutingExperimentIdsExpected.add(4264);
