...
public class S11ovl3_2SU2cLowHighFlexibleInflexible7525 {
	String db = "SimLabOV";
	String basicName = "S11ovl3_2SU2cLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 49207;
	//int firstOrderRequestSetIdForTOP=5303;
	int firstOrderRequestSetIdForTOPExpected =49307;
	int learningRequestSetsExperimentId = 12726;
	...
	public S11ovl3_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(12733);
		learningRoutingExperimentIdsExpected.add(12733);
