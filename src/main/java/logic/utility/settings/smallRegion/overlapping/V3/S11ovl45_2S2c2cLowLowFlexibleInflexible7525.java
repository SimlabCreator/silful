...
public class S11ovl45_2S2c2cLowLowFlexibleInflexible7525 {

	String db = "SimLabOV";
	String basicName = "S11ovl45_2S2c2cLowLowFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 33607;
	//int firstOrderRequestSetIdForTOP=21304;
	int firstOrderRequestSetIdForTOPExpected =33707;
	...
	public S11ovl45_2S2c2cLowLowFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(8494);
		learningRoutingExperimentIdsExpected.add(8494);
