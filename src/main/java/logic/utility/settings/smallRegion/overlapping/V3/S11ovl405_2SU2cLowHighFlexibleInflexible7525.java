package logic.utility.settings.smallRegion.overlapping.V3;
...
public class S11ovl405_2SU2cLowHighFlexibleInflexible7525 {
	
	String db = "SimLabOVL";
	String basicName = "S11ovl405_2SU2cLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 52002;
	//int firstOrderRequestSetIdForTOP=5303;
	int firstOrderRequestSetIdForTOPExpected =52102;
	int learningRequestSetsExperimentId = 12724;
	...
	public S11ovl405_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(12828);
		learningRoutingExperimentIdsExpected.add(12828);
