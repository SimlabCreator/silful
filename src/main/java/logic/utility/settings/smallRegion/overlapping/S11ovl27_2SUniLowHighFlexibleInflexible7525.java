...
public class S11ovl27_2SUniLowHighFlexibleInflexible7525 {
	String db = "SimLabOVL";
	String basicName = "S11ovl27_2SUniLowHighFlexibleInflexible7525_";
	...
	int noVehicles =2;
	int demandSegmentWeightingId = 53;
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 26002;
	//int firstOrderRequestSetIdForTOP=5303;
	int firstOrderRequestSetIdForTOPExpected =26102;
	int learningRequestSetsExperimentId = 19;
	...
	public S11ovl27_2SUniLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(4459);
		learningRoutingExperimentIdsExpected.add(4459);
