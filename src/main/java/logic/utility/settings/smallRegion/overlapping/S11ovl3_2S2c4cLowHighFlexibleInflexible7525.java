...
public class S11ovl3_2S2c4cLowHighFlexibleInflexible7525 {

	String db = "SimLabOV";
	String basicName = "S11ovl3_2S2c4cLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 23207;
	//int firstOrderRequestSetIdForTOP=103;
	int firstOrderRequestSetIdForTOPExpected =23307;
	...
	public S11ovl3_2S2c4cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(4364);
		learningRoutingExperimentIdsExpected.add(4364);
