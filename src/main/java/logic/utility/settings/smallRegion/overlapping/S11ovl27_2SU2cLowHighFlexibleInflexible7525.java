package logic.utility.settings.smallRegion.overlapping;
...
public class S11ovl27_2SU2cLowHighFlexibleInflexible7525 {
	String db = "SimLabOVL";
	String basicName = "S11ovl27_2SU2cLowHighFlexibleInflexible7525_";
	...
	int noVehicles =2;
	int demandSegmentWeightingId = 63;
	...
	//int firstOrderRequestSetIdForTOP=5303;
	int firstOrderRequestSetIdForTOPExpected =46902;
	int learningRequestSetsExperimentId = 12721;
	...
	public S11ovl27_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(12728);
		learningRoutingExperimentIdsExpected.add(12728);
