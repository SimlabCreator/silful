...
public class S11ovl405_2SUniLowHighFlexibleInflexible7525 {
	
	String db = "SimLabOVL";
	String basicName = "S11ovl405_2SUniLowHighFlexibleInflexible7525_";
	...
	public S11ovl405_2SUniLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(8689);
		learningRoutingExperimentIdsExpected.add(8689);
