...
public class S12l3_2S2c4cLowHighFlexibleInflexible7525 {
	//Result: (S10l25_2S2c4cLowHighFlexibleI(S10l25_2S2c4cLowHighFlexibleInflexible7525_DG_Training:7)

	String basicName = "S12l3_2S2c4cLowHighFlexibleInflexible7525_";
	...
	int noVehicles =2;
	int demandSegmentWeightingId = 40;
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 3;
	int firstOrderRequestSetIdForTOP=103;
	int firstOrderRequestSetIdForTOPExpected =20803;
	int learningRequestSetsExperimentId =5;
	...
	public S12l3_2S2c4cLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(19);
		learningRoutingExperimentIdsExpected.add(119);
