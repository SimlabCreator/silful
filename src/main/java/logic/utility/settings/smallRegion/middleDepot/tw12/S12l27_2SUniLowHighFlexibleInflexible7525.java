package logic.utility.settings.smallRegion.middleDepot.tw12;

import java.util.ArrayList;

import logic.utility.settings.RunExperimentHelper;

public class S12l27_2SUniLowHighFlexibleInflexible7525 {

	String basicName = "S12l27_2SUniLowHighFlexibleInflexible7525_";
	int bookingPeriodLength = 500;
	int regionId = 8;
	int depotId = 7;
	int deliveryAreaSetId = 35;
	int vehicleAssignmentSetId = 30;
	int noVehicles =2;
	int demandSegmentWeightingId = 39;
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 42404;
	int firstOrderRequestSetIdForTOP=42504;
	int firstOrderRequestSetIdForTOPExpected =42604;
	int learningRequestSetsExperimentId = 14736;
	...
	public S12l27_2SUniLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(15149);
		learningRoutingExperimentIdsExpected.add(15249);
