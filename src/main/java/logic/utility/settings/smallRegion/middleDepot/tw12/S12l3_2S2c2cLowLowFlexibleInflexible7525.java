...
public class S12l3_2S2c2cLowLowFlexibleInflexible7525 {
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 21204;
	int firstOrderRequestSetIdForTOP=21304;
	int firstOrderRequestSetIdForTOPExpected =21404;
	int learningRequestSetsExperimentId =10080;
	...
	public S12l3_2S2c2cLowLowFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(10085);
		learningRoutingExperimentIdsExpected.add(10185);
