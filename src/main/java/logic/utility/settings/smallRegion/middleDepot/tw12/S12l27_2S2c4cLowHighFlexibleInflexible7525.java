...
public class S12l27_2S2c4cLowHighFlexibleInflexible7525 {
	//Result: (S10l25_2S2c4cLowHighFlexibleI(S10l25_2S2c4cLowHighFlexibleInflexible7525_DG_Training:7)

	String basicName = "S12l27_2S2c4cLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 37104;
	int firstOrderRequestSetIdForTOP=37204;
	int firstOrderRequestSetIdForTOPExpected =37304;
	int learningRequestSetsExperimentId =14732;
	...
	public S12l27_2S2c4cLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(14949);
		learningRoutingExperimentIdsExpected.add(15049);
