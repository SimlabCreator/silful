...
public class S12l27_2S2c2cLowLowFlexibleInflexible7525 {
	//Result: (S10l25_2S2c4cLowHighFlexibleI(S10l25_2S2c4cLowHighFlexibleInflexible7525_DG_Training:7)

	String basicName = "S12l27_2S2c2cLowLowFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 31804;
	int firstOrderRequestSetIdForTOP=31904;
	int firstOrderRequestSetIdForTOPExpected =32004;
	int learningRequestSetsExperimentId =14728;
	...
	public S12l27_2S2c2cLowLowFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(14749);
		learningRoutingExperimentIdsExpected.add(14849);
