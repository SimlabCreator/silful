...
public class S12l3_2SUniLowHighFlexibleInflexible7525 {

	String basicName = "S12l3_2SUniLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 5203;
	int firstOrderRequestSetIdForTOP=5303;
	int firstOrderRequestSetIdForTOPExpected =20903;
	int learningRequestSetsExperimentId = 8;
	...
	public S12l3_2SUniLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(219);
		learningRoutingExperimentIdsExpected.add(319);
