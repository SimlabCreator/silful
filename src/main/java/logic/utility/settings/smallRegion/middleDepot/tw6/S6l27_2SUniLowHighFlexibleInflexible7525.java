package logic.utility.settings.smallRegion.middleDepot.tw6;

import java.util.ArrayList;

import logic.utility.settings.RunExperimentHelper;

public class S6l27_2SUniLowHighFlexibleInflexible7525 {

	String basicName = "S6l27_2SUniLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 58304;
	int firstOrderRequestSetIdForTOP=58404;
	int firstOrderRequestSetIdForTOPExpected=58504;
	int learningRequestSetsExperimentId = 14748;
	...
	public S6l27_2SUniLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(15749);
		learningRoutingExperimentIdsExpected.add(15849);
