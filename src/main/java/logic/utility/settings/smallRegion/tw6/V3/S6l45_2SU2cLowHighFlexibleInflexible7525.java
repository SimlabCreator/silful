...
public class S6l45_2SU2cLowHighFlexibleInflexible7525 {

	String db = "SimLabu2c";
	String basicName = "S6l45_2SU2cLowHighFlexibleInflexible7525_";
...
//	int firstOrderRequestSetIdForTOP=15703;
	...
	public S6l45_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(238);
		learningRoutingExperimentIdsExpected.add(238);
