...
public class S6l405_2SU2cLowHighFlexibleInflexible7525 {

	String db = "SimLabu2c";
	String basicName = "S6l405_2SU2cLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 15602;
//	int firstOrderRequestSetIdForTOP=15703;
	int firstOrderRequestSetIdForTOPExpected=15702;
	...
	public S6l405_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(338);
		learningRoutingExperimentIdsExpected.add(338);
