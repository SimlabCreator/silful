package logic.utility.settings.smallRegion.playProblems;
...
public class S6l27_2SU2cLowHighFlexibleInflexible7525_250 {

	String db = "Playground";
	String basicName = "S6l27_2SU2cLowHighFlexibleInflexible7525_250";
	int bookingPeriodLength = 250;
	int regionId = 8;
	int depotId = 9;
	int deliveryAreaSetId = 35;
	int vehicleAssignmentSetId = 36;
	int noVehicles =2;
	int demandSegmentWeightingId = 61;
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 5202;
//	int firstOrderRequestSetIdForTOP=15703;
	int firstOrderRequestSetIdForTOPExpected=5302;
	int learningRequestSetsExperimentId = 7;
	...
	public S6l27_2SU2cLowHighFlexibleInflexible7525_250() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(138);
		learningRoutingExperimentIdsExpected.add(138);
