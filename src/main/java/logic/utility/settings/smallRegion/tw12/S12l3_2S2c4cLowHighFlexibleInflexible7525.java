...
public class S12l3_2S2c4cLowHighFlexibleInflexible7525 {
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation =52902;
	//int firstOrderRequestSetIdForTOP=103;
	int firstOrderRequestSetIdForTOPExpected =53002;
	int learningRequestSetsExperimentId =23656;
	...
	public S12l3_2S2c4cLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(23778);
		learningRoutingExperimentIdsExpected.add(23778);
