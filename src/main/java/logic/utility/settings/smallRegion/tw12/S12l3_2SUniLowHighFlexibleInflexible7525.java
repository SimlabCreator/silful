...
public class S12l3_2SUniLowHighFlexibleInflexible7525 {
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 58102;
	//int firstOrderRequestSetIdForTOP=5303;
	int firstOrderRequestSetIdForTOPExpected =58202;
	int learningRequestSetsExperimentId = 23659;
	...
	public S12l3_2SUniLowHighFlexibleInflexible7525() {
		learningRoutingExperimentIds.add(23878);
		learningRoutingExperimentIdsExpected.add(23878);
