...
public class S12l3_2SU2cLowHighFlexibleInflexible7525 {
	String db = "SimLabu2c";
	String basicName = "S12l3_2SU2cLowHighFlexibleInflexible7525_";
	...
	//Adapt!
	int firstOrderRequestSetIdForValiation = 20802;
	//int firstOrderRequestSetIdForTOP=5303;
	int firstOrderRequestSetIdForTOPExpected =20902;
	int learningRequestSetsExperimentId = 16;
	...
	public S12l3_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(438);
		learningRoutingExperimentIdsExpected.add(438);
