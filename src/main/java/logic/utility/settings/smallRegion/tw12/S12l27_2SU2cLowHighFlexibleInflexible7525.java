...
public class S12l27_2SU2cLowHighFlexibleInflexible7525 {

	String db = "SimLabu2c";
	String basicName = "S12l27_2SU2cLowHighFlexibleInflexible7525_";
	...
	public S12l27_2SU2cLowHighFlexibleInflexible7525() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(538);
		learningRoutingExperimentIdsExpected.add(538);
