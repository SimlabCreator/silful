...
public class S6l3_2S2c4cLowHighFlexibleInflexible7525_16 {

	String basicName = "S6l3_2S2c4cLowHighFlexibleInflexible7525_16";
	String db= "SimLab";
	...
	int firstOrderRequestSetIdForTOPExpected =94602;
	int learningRequestSetsExperimentId = 55737;
	...
	public S6l3_2S2c4cLowHighFlexibleInflexible7525_16() {
...
//				arrivalProcess, false);
	...
	public String runAnn(Integer valueFunctionModelSetId) {
		...
		RunExperimentHelper.runANNExperiments(new RunExperimentHelper(), new HashMap<String, Double>(), 
				...
				arrivalProcess, firstOrderRequestSetIdForValiation, noVehicles, depotId, resultLog, 
				valueFunctionModelSetId, 3.0);
