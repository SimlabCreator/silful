...
public class S6l3_2S2c4cLowHighFlexibleInflexible7525_64 {

	String basicName = "S6l3_2S2c4cLowHighFlexibleInflexible7525_64";
	String db= "SimLab";
	...
	int firstOrderRequestSetIdForValiation = 68502;
//	int firstOrderRequestSetIdForTOP=10503;
	int firstOrderRequestSetIdForTOPExpected =99802;
	int learningRequestSetsExperimentId = 55740;
	...
	public S6l3_2S2c4cLowHighFlexibleInflexible7525_64() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(55841);
		learningRoutingExperimentIdsExpected.add(55841);
...
//				arrivalProcess, false);
	...
	public String runAnn(Integer valueFunctionModelSetId) {
		...
		RunExperimentHelper.runANNExperiments(new RunExperimentHelper(), new HashMap<String, Double>(), 
				...
				arrivalProcess, firstOrderRequestSetIdForValiation, noVehicles, 
				depotId, resultLog, valueFunctionModelSetId, 3.0);
