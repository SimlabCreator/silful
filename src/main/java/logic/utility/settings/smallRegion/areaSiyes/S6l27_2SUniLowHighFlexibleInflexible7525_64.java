package logic.utility.settings.smallRegion.areaSiyes;
...
public class S6l27_2SUniLowHighFlexibleInflexible7525_64 {

	String db = "SimLabLow";
	String basicName = "S6l27_2SUniLowHighFlexibleInflexible7525_64_";
	int bookingPeriodLength = 500;
	int regionId = 8;
	int depotId = 9;
	int deliveryAreaSetId = 43;
	int vehicleAssignmentSetId = 45;
	int noVehicles =2;
	int demandSegmentWeightingId = 41;
	int serviceSegmentWeightingId=1;
	int timeWindowSetId = 12;
	int arrivalProcess = 13;
	int arrivalProbabilityDistributionId=50;
	
	//Adapt!
	int firstOrderRequestSetIdForValiation = 46802;
//	int firstOrderRequestSetIdForTOP=15703;
	int firstOrderRequestSetIdForTOPExpected=46902;
	int learningRequestSetsExperimentId = 31;
	...
	public S6l27_2SUniLowHighFlexibleInflexible7525_64() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(938);
		learningRoutingExperimentIdsExpected.add(938);
