...
public class S6l27_2S2c4cLowHighFlexibleInflexible7525_64 {

	String db = "SimLabLow";
	String basicName = "S6l27_2S2c4cLowHighFlexibleInflexible7525_64_";
...
//	int firstOrderRequestSetIdForTOP=10503;
	int firstOrderRequestSetIdForTOPExpected =67702;
	int learningRequestSetsExperimentId = 17064;
	...
	public S6l27_2S2c4cLowHighFlexibleInflexible7525_64() {
		SettingsProvider.database=db;
		learningRoutingExperimentIds.add(17165);
		learningRoutingExperimentIdsExpected.add(17165);
...
//				arrivalProcess, false);
	...
	public String runAnn(Integer valueFunctionModelSetId) {
		String resultLog="";
		String adpName = "ADP_";
		RunExperimentHelper.runANNExperiments(new RunExperimentHelper(), new HashMap<String, Double>(), 
				resultLog, adpName, regionId, bookingPeriodLength, learningRequestSetsExperimentId, 
				demandSegmentWeightingId, deliveryAreaSetId, vehicleAssignmentSetId, learningRoutingExperimentIdsExpected, 
				arrivalProcess, firstOrderRequestSetIdForValiation, 
